...
public class DisplayMetricsAndroid : MonoBehaviour {
	// Singleton
	public static DisplayMetricsAndroid Instance;
	...
	void Awake()
	{
		...
		{
			Debug.LogError("Multiple instances of DisplayMetricsAndroid");
            Destroy(this);
		}
	...
	static void DisplayMetrics() {
		...
		Debug.Log("HeightPixels: " + HeightPixels );
		Debug.Log("WidthPixels: " + WidthPixels );
	}
